...
ReactDOM.render(
  <React.StrictMode>
      <Results searchBlock={searchBlock} grid={true} perPage={30} ref={results}/>
  </React.StrictMode>,
  content
);
ReactDOM.render(
...
ReactDOM.render(
  <React.StrictMode>
      <AutoComplete
          ...
          dataSource={localStorage.getItem('usernames') === null ? [] : JSON.parse(localStorage.getItem('usernames'))}
        />
      <AutoComplete
